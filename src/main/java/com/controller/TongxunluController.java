    ...
    */
    ...
    public R save(@RequestBody TongxunluEntity tongxunlu, HttpServletRequest request){
        ...
        Wrapper<TongxunluEntity> queryWrapper = new EntityWrapper<TongxunluEntity>()
            ...
            .eq("tongxunlu_beizhu", tongxunlu.getTongxunluBeizhu())
...
//                            tongxunluEntity.setTongxunluName(data.get(0));                    //名称 要改的
//                            tongxunluEntity.setTongxunluBeizhu(data.get(0));                    //备注 要改的
//                            tongxunluEntity.setTongxunluPhone(data.get(0));                    //联系方式 要改的
//                            tongxunluEntity.setTongxunluTypes(Integer.valueOf(data.get(0)));   //类型 要改的
