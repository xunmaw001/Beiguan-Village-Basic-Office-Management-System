    ...
    */
    ...
    public R save(@RequestBody RichengEntity richeng, HttpServletRequest request){
        ...
        Wrapper<RichengEntity> queryWrapper = new EntityWrapper<RichengEntity>()
            ...
            .eq("richeng_time", new SimpleDateFormat("yyyy-MM-dd").format(richeng.getRichengTime()))
            ;
...
//                            richengEntity.setRichengName(data.get(0));                    //标题 要改的
...
//                            richengEntity.setKaoqinContent("");//详情和图片
